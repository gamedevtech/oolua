...
#define OOLUA_C_FUNCTION_1(return_value,func,P1) \
	...
	return OOLUA::lua_return_count< Type_list<R,P1_ >::type> ::out;\
...
#define OOLUA_C_FUNCTION_2(return_value,func,P1,P2) \
	...
	return OOLUA::lua_return_count< Type_list<R,P1_,P2_ >::type> ::out;\
...
#define OOLUA_C_FUNCTION_3(return_value,func,P1,P2,P3) \
	...
	return OOLUA::lua_return_count< Type_list<R,P1_,P2_,P3_ >::type> ::out;\
...
#define OOLUA_C_FUNCTION_4(return_value,func,P1,P2,P3,P4) \
	...
	return OOLUA::lua_return_count< Type_list<R,P1_,P2_,P3_,P4_ >::type> ::out;\
...
#define OOLUA_C_FUNCTION_5(return_value,func,P1,P2,P3,P4,P5) \
	...
	return OOLUA::lua_return_count< Type_list<R,P1_,P2_,P3_,P4_,P5_ >::type> ::out;\
...
#define OOLUA_C_FUNCTION_6(return_value,func,P1,P2,P3,P4,P5,P6) \
	...
	return OOLUA::lua_return_count< Type_list<R,P1_,P2_,P3_,P4_,P5_,P6_ >::type> ::out;\
...
#define OOLUA_C_FUNCTION_7(return_value,func,P1,P2,P3,P4,P5,P6,P7) \
	...
	return OOLUA::lua_return_count< Type_list<R,P1_,P2_,P3_,P4_,P5_,P6_,P7_ >::type> ::out;\
...
#define OOLUA_C_FUNCTION_8(return_value,func,P1,P2,P3,P4,P5,P6,P7,P8) \
	...
	return OOLUA::lua_return_count< Type_list<R,P1_,P2_,P3_,P4_,P5_,P6_,P7_,P8_ >::type> ::out;\
