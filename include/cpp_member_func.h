...
*/
#define OOLUA_MEM_FUNC_N(return_value, func , ...)						OOLUA_MEMBER_BODY_N(      , func, return_value, func , __VA_ARGS__ ) /*NOLINT*/
#define OOLUA_MEM_FUNC_CONST_N(return_value, func , ...)				OOLUA_MEMBER_BODY_N(const , func, return_value, func , __VA_ARGS__ )
#define OOLUA_MEM_FUNC_RENAME_N(name, return_value, func , ...)			OOLUA_MEMBER_BODY_N(      , name, return_value, func , __VA_ARGS__ ) /*NOLINT*/
#define OOLUA_MEM_FUNC_CONST_RENAME_N(name, return_value, func , ...)	OOLUA_MEMBER_BODY_N(const , name, return_value, func , __VA_ARGS__ )

#define OOLUA_MEM_FUNC_0(return_value, func)						OOLUA_MEMBER_BODY_0(      , func, return_value, func) /*NOLINT*/
#define OOLUA_MEM_FUNC_CONST_0(return_value, func)					OOLUA_MEMBER_BODY_0(const , func, return_value, func)
#define OOLUA_MEM_FUNC_RENAME_0(name, return_value, func)			OOLUA_MEMBER_BODY_0(      , name, return_value, func) /*NOLINT*/
