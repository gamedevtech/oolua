...
TEST_OOLUA_MEM_FUNC(void,four,int,int,int,int)
	//OOLUA_MEM_FUNC_4(void, four,int, int ,int ,int )	
TEST_OOLUA_MEM_FUNC(void,five,int,int,int,int,int)
...
TEST_OOLUA_MEM_FUNC(void, eight,int, int ,int ,int ,int ,int ,int ,int)
